...
//import org.apache.calcite.rel.`type`.RelDataTypeFactory.FieldInfo
...
//    val list: util.List[Future[RDD[(ImmutableBytesWritable, Result)]]]=new util.ArrayList[Future[RDD[(ImmutableBytesWritable, Result)]]]()
